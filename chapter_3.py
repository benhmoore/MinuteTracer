...
# Spheres
my_world.addObject(Sphere(1, (0,-1,3), (255,0,0), 500))
my_world.addObject(Sphere(1, (2,0,4), (0,0,255), 500))
my_world.addObject(Sphere(1, (-2,0,4), (0,255,0), 10))
my_world.addObject(Sphere(5000, (0,-5001,0), (255,255,0), 1000))
